<div id="CI00000004">
	<div class="pageHere">
		<span class="first">기업관리</span> &gt; <strong>작업관리</strong>
	</div>
	<!-- searchWrap -->
	<div class="searchWrapArea">
		<input type="hidden" name="orderculumn" value="sp.sort">
		...
		<table cellpadding="0" cellspacing="0" summary="" class="noBdrTb tr_nohover">
			...
			<tbody>
				<tr>
					<th class="ar">· 공정</th>
					<td>
						<select name="spSeq" class="schColumBorderColorDefault"></select>
					</td>
					<th class="ar">· 작업명</th>
					<td>
						<div class="inputTextCleanDiv">
							<input class="w98p schColumBorderTextDefault" name="schValue" style="height:28px !important;" type="text" placeholder="" autocomplete="false">
					...
					<!-- <th>· 조회기간</th>
					<td>
						<input class="date crdrIp" type="text" name="schStartDts" placeholder="날짜 선택">
						 ~
						 <input class="date crdrIp" type="text" name="schEndDts" placeholder="날짜 선택">
					</td> -->
					<td>
		...
		<table class="listTbType02 tr_nohover tablScrollDisplay dataHeadTable scrollTbThead"  id="" style="margin: 0px !important;" cellspacing="0" cellpadding="0" summary="">
			...
			<thead>
				<tr>
					...
					<th class="sortTd" column="spNm">공정명 <img src="/images/btn/btn_sort2.png" alt="" class="vm" style="cursor:pointer;"></th>
					<th class="sortTd" column="cwNm">작업명 <img src="/images/btn/btn_sort2.png" alt="" class="vm" style="cursor:pointer;"></th>
					<th class="sortTd" column="cw.sort">노출순서 <img src="/images/btn/btn_sort2.png" alt="" class="vm" style="cursor:pointer;"></th>
					<th >주문 세부사항 </th>
					<th >작업 세부사항 </th>
					<th ><i class="fa-regular fa-clone"></i></th>
					<th class="last">수정</th>
				</tr>
			</thead>
		</table>
