				...
				<tr>
					...
					<td>
						<div class="inputTextCleanDiv">
							...
							<input class="w98p schColumBorderTextDefault" name="searchWord" type="text" style="height:28px !important;" placeholder="" autocomplete="false">
		...
		<table class="listTbType02 tr_nohover tablScrollDisplay dataHeadTable scrollTbThead"  id="" style="margin: 0px !important;" cellspacing="0" cellpadding="0" summary="">
			...
			<thead>
				<tr>
					...
					<th class="sortTd" column="eqNm">보관창고 <img src="/images/btn/btn_sort2.png" alt="" class="vm" style="cursor:pointer;"></th>
					<th >주소 </th>
					<th >전화번호 </th>
			...
			<div class="mw_contents">
				...
				<div class="searchWrap">
					<table cellpadding="0" cellspacing="0" border="0" summary="" class="noBdrTb tr_nohover mb10">
						...
						<tbody>
							<tr>
								<th class="ac"><span style="color:red;">*</span> 보관창고</th>
								<td colspan="5">
									<div class="inputTextCleanDiv">
										<input type="text" name="cpNm" style="width:150px;" requiremsg="보관창고명" placeholder="보관창고명">
										<div class="inputTextClean"><span>×</span></div>
									</div>
								</td>
							...
							<tr>
								...
								<td class="">
									<div class="inputTextCleanDiv">
										<input type="text" name="cpTel" style="width:150px;"  placeholder="전화번호">
										<div class="inputTextClean"><span>×</span></div>
									</div>
								</td>
								<th class="ac">순&nbsp;&nbsp;&nbsp;&nbsp;서</th>
								<td>
									<div class="inputTextCleanDiv">
										<input name="sort" type="text" style="width:40px;">
										<div class="inputTextClean"><span>×</span></div>
									</div>
								</td>						
								<th class="ac">사용여부</th>
								<td class="al"><select name="useYn"><option value="Y">사용중</option><option value="N">미사용</option></select></td>						
							...
							<tr>
								...
								<td colspan="5">
										...
										<input name="cpAddr" class="readonly" type="text" style="width:160px;" placeholder="기본 주소" readonly="readonly">
										<div class="inputTextCleanDiv">
							...
							<tr>
								<th class="ac">메&nbsp;&nbsp;&nbsp;&nbsp;모</th>
								<td colspan="5"><textarea name="eqMemo" class="w99p" rows="1" placeholder="메모"></textarea></td>
							</tr>
						</tbody>
					</table>
				</div>
